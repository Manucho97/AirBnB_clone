...
## Project Description
The first part of Alx SE AirBnB project where the console is used as an interface of the back-end development
Data is stored in a javascript object notation JSON that is surpported through a built in package called python
...
**Emmanuel Mukangai** <[manucho97](https://github.com/Manucho97/AirBnB_clone)>
